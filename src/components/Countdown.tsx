  ...
  const getMonthData = (year: number, month: number) => {
    ...
    while (currentDate <= lastDay || currentDate.getDay() !== 0) {
      ...
      const isSpecialGreen = 
        ...
        (currentDate >= new Date(2026, 2, 20) && currentDate <= new Date(2026, 2, 22)) || // Mar 20 - Mar 22
      ...
      const isSpecialBlue = 
        ...
        (currentDate >= new Date(2026, 2, 15) && currentDate <= new Date(2026, 2, 19)) || // Mar 15 - Mar 19
        (currentDate.getFullYear() === 2026 && currentDate.getMonth() === 4 && (currentDate.getDate() === 22 || currentDate.getDate() === 23)) || // May 22, May 23
